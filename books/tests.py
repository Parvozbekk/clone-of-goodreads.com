...
class BookTestCase(TestCase):
    ...
    def test_books_list(self):
        ...
        book2 = Book.objects.create(title="Book2", description="Description2", isbn="1231231")
        book3 = Book.objects.create(title="Book3", description="Description3", isbn="1231232")
    ...
    def test_search_books(self):
        ...
        book2 = Book.objects.create(title="Guide", description="Description2", isbn="1231231")
        book3 = Book.objects.create(title="College", description="Description3", isbn="1231232")
        ...
        response = self.client.get(reverse("books:list") + '?q=college')
        self.assertContains(response, book3.title)
        self.assertNotContains(response, book2.title)
        self.assertNotContains(response, book1.title)
